...
@admin.register(EmployeeEmploymentHistory)
class EmployeeEmploymentHistoryAdmin(admin.ModelAdmin):
    list_display = ('employee', 'action', 'effective_date', 'status', 'actor')
...
class EmployeeDocumentAdmin(admin.ModelAdmin):
    list_display = ('employee', 'document_type', 'name', 'expiry_date', 'is_verified')
    list_filter = ('document_type', 'is_verified')
    search_fields = ('employee__employee_number', 'employee__last_name', 'name', 'reference_number')
