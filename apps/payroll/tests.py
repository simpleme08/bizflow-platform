...
class PayrollCalculatorTests(TestCase):
    ...
    def test_calculator_returns_exact_decimal_components(self):
        ...
        self.assertEqual(result, {
            ...
            'undertime_deduction': Decimal('0.00'), 'sss_employee': Decimal('500.00'), 'sss_employer': Decimal('1015.00'),
            'philhealth_employee': Decimal('250.00'), 'philhealth_employer': Decimal('250.00'),
            'pagibig_employee': Decimal('50.00'), 'pagibig_employer': Decimal('50.00'),
    ...
    def test_monthly_period_uses_monthly_salary_and_contributions(self):
        monthly_period = PayrollPeriod.objects.create(
            organization=self.employee.organization,
            name='August 2026 Monthly',
            start_date=date(2026, 8, 1),
        ...
        self.assertEqual(result['withholding_tax'], Decimal('139.45'))
