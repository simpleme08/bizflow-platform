...
class Organization(BaseModel):
    ...
    class Meta:
        ordering = ('name',)
        constraints = [models.CheckConstraint(condition=models.Q(overage_rate__gte=0), name='organization_overage_rate_nonnegative')]
...
class OrganizationMembership(BaseModel):
    ...
    ROLE_PERMISSIONS = {
        ...
        'HR': {'manage_users','manage_employees','manage_attendance','approve_leave','view_payroll','manage_payroll','approve_payroll','disburse_payroll','view_reports','manage_recruiting','manage_performance','manage_benefits','manage_offboarding'},
