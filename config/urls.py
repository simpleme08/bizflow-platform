...
from apps.employees.views import employee_directory, employee_directory_page, employee_document_api, employee_lifecycle_action, employee_profile
...
urlpatterns = [
    ...
    path('scheduling/', scheduling_page, name='scheduling-page'), path('api/dashboard/', dashboard, name='dashboard'), path('api/employees/', employee_directory, name='employee-directory'), path('api/employees/<uuid:employee_id>/', employee_profile, name='employee-profile'), path('api/employees/<uuid:employee_id>/lifecycle/', employee_lifecycle_action, name='employee-lifecycle'), path('api/employees/<uuid:employee_id>/documents/', employee_document_api, name='employee-documents'), path('api/attendance/', record_attendance, name='record-attendance'),
