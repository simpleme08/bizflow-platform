...
urlpatterns = [
    ...
    path('clock/login/', clock_login, name='clock-login'), path('clock/action/', clock_action, name='clock-action'), path('login/', login_page, name='login'), path('select-organization/', organization_select, name='organization-select'), path('logout/', auth_views.LogoutView.as_view(), name='logout'),
